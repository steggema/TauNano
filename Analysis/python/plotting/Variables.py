...
generic_vars = [
    ...
    VCfg(name='max_mt', drawname='max(mt_1, mt_2)', binning={'nbinsx':60, 'xmin':0., 'xmax':600.}, unit='GeV', xtitle='max(M_{T} (leg 1), M_{T} (leg 2))'),
    ...
    VCfg(name='mt_1', binning={'nbinsx':60, 'xmin':0., 'xmax':300.}, unit='GeV', xtitle='m_{T} leg 1'),
    ...
    VCfg(name='mt_2', binning={'nbinsx':60, 'xmin':0., 'xmax':300.}, unit='GeV', xtitle='m_{T} leg 2'),
    ...
    VCfg(name='mt_sum', drawname='mt_1 + mt_2', binning={'nbinsx':60, 'xmin':0., 'xmax':1000.}, unit='GeV', xtitle='Sum m_{T} (MET-leg1, MET-leg2)'),
    VCfg(name='PV_npvsGood', binning={'nbinsx':81, 'xmin':-0.5, 'xmax':80.5}, unit=None, xtitle='N_{good vertices}'),
    VCfg(name='PV_npvs', binning={'nbinsx':81, 'xmin':-0.5, 'xmax':80.5}, unit=None, xtitle='N_{vertices}'),
    ...
    VCfg(name='ptvis', binning={'nbinsx':50, 'xmin':0, 'xmax':250.}, unit='GeV', xtitle='p_{T}^{l1+l2}'),
...
muon_l1_vars = [
    VCfg(name='pt_1', binning={'nbinsx':40, 'xmin':0., 'xmax':100.}, unit='GeV', xtitle='muon p_{T}'),
    VCfg(name='eta_1', binning={'nbinsx':20, 'xmin':-2.5, 'xmax':2.5}, unit=None, xtitle='muon #eta'),
    VCfg(name='phi_1', binning={'nbinsx':40, 'xmin':-3.141593, 'xmax':3.141593}, unit=None, xtitle='muon #phi'),
    ...
    VCfg(name='d0_1_log', drawname='log(abs(d0_1))', binning={'nbinsx':40, 'xmin':-18., 'xmax':-2.}, unit='log(cm)', xtitle='log(muon d_{0})'),
    VCfg(name='dxy_1_log', drawname='log(abs(dxy_1))', binning={'nbinsx':40, 'xmin':-18., 'xmax':-2.}, unit='log(cm)', xtitle='log(muon d_{xy})'),
    ...
    VCfg(name='dz_1_log', drawname='log(abs(dz_1))', binning={'nbinsx':40, 'xmin':-18., 'xmax':-2.}, unit='log(cm)', xtitle='log(muon d_{z})'),
...
tau_l1_vars = [
    ...
    VCfg(name='l1_byIsolationMVArun2v1DBoldDMwLTraw_zoom', drawname='l1_byIsolationMVArun2v1DBoldDMwLTraw', binning={'nbinsx':20, 'xmin':0.9, 'xmax':1.}, unit='', xtitle='tau_{1} isolation MVA (old DM w/LT)'),
...
tau_l2_vars = [
    VCfg(name='pt_2', binning={'nbinsx':50, 'xmin':0., 'xmax':250.}, unit='GeV', xtitle='tau p_{T}'),
    VCfg(name='eta_2', binning={'nbinsx':20, 'xmin':-2.5, 'xmax':2.5}, unit=None, xtitle='tau #eta'),
    VCfg(name='phi_2', binning={'nbinsx':40, 'xmin':-3.141593, 'xmax':3.141593}, unit=None, xtitle='tau #phi'),
    # VCfg(name='mt_2', binning={'nbinsx':50, 'xmin':0., 'xmax':200.}, unit='GeV', xtitle='m_{T} #tau'),
    VCfg(name='decayMode_2', binning={'nbinsx':12, 'xmin':-0.5, 'xmax':11.5}, unit=None, xtitle='tau decay mode'),
    VCfg(name='m_2', binning={'nbinsx':40, 'xmin':0., 'xmax':3.}, unit='GeV', xtitle='tau mass'),
    # VCfg(name='l2_jet_pt', binning={'nbinsx':40, 'xmin':0., 'xmax':240.}, unit='GeV', xtitle='tau jet p_{T}'),
    # VCfg(name='gen_match_2', binning={'nbinsx':40, 'xmin':-17.5, 'xmax':22.5}, unit=None, xtitle='tau gen match PDG ID'),
    VCfg(name='dxy_2_log', drawname='log(abs(dxy_2)+0.00001)', binning={'nbinsx':40, 'xmin':-18., 'xmax':0.5}, unit='log(cm)', xtitle='log(tau d_{xy})'),
    ...
    VCfg(name='dz_2_log', drawname='log(abs(dz_2)+0.00001)', binning={'nbinsx':40, 'xmin':-18., 'xmax':0.5}, unit='log(cm)', xtitle='log(tau d_{z})'),
    ...
    VCfg(name='rawIso_2', binning={'nbinsx':20, 'xmin':0., 'xmax':5.}, unit='GeV', xtitle='tau delta-beta corr. 3-hit isolation'),
    # VCfg(name='rawMVAoldDM2017v2_2', binning={'nbinsx':100, 'xmin':-1., 'xmax':1.}, unit='', xtitle='tau 2017 isolation MVA (old DM w/LT)'),
    # VCfg(name='rawMVAoldDMdR032017v2_2', binning={'nbinsx':100, 'xmin':0., 'xmax':1.}, unit='', xtitle='tau isolation MVA (old DM w/LT cone 0.3)'),
    # VCfg(name='rawMVAoldDM2017v2_2_zoom', drawname='rawMVAoldDM2017v2_2', binning={'nbinsx':20, 'xmin':0.9, 'xmax':1.}, unit='', xtitle='tau 2017 isolation MVA (old DM w/LT)'),
    ...
    # VCfg(name='l2_pt_weighted_dr_iso', binning={'nbinsx':50, 'xmin':0., 'xmax':0.5}, unit=None, xtitle='p_{T}-weighted #Delta R (isolation)'),
    # VCfg(name='l2_pt_weighted_dr_signal', binning={'nbinsx':50, 'xmin':0., 'xmax':0.11}, unit=None, xtitle='p_{T}-weighted #Delta R (signal)'),
    # VCfg(name='l2_pt_weighted_dphi_strip', binning={'nbinsx':50, 'xmin':0., 'xmax':0.5}, unit=None, xtitle='p_{T}-weighted #Delta #phi (strip)'),
    # VCfg(name='l2_pt_weighted_deta_strip', binning={'nbinsx':50, 'xmin':0., 'xmax':0.5}, unit=None, xtitle='p_{T}-weighted #Delta #eta (strip)'),
    # VCfg(name='l2_flightLength', drawname='log(abs(l2_flightLength)+0.001)', binning={'nbinsx':40, 'xmin':-8., 'xmax':4.}, unit='log(cm)', xtitle='log(tau flight length)'),
    # VCfg(name='l2_flightLengthSig', binning={'nbinsx':40, 'xmin':-12., 'xmax':50.}, unit=None, xtitle='tau flight length significance'),
    # VCfg(name='l2_dxy_Sig', binning={'nbinsx':40, 'xmin':-50., 'xmax':50.}, unit='log(cm)', xtitle='tau d_{xy} significance'),
    # VCfg(name='l2_ip3d', drawname='log(abs(l2_ip3d))*TMath::Sign(1, l2_ip3d)', binning={'nbinsx':40, 'xmin':-11., 'xmax':11.}, unit='log(cm)', xtitle='log(tau 3D impact parameter)'),
    # VCfg(name='l2_ip3d_Sig',  binning={'nbinsx':40, 'xmin':-40., 'xmax':50.}, unit=None, xtitle='tau 3D IP significance'),
    # VCfg(name='l2_e_over_h', binning={'nbinsx':40, 'xmin':0., 'xmax':1.0001}, unit=None, xtitle='tau E/H'),
    # VCfg(name='l2_n_photons', binning={'nbinsx':19, 'xmin':-0.5, 'xmax':18.5}, unit=None, xtitle='tau n(photons)'),
]

muon_l2_vars = [
    VCfg(name='pt_2', binning={'nbinsx':40, 'xmin':0., 'xmax':100.}, unit='GeV', xtitle='muon_{2} p_{T}'),
    VCfg(name='eta_2', binning={'nbinsx':20, 'xmin':-2.5, 'xmax':2.5}, unit=None, xtitle='muon_{2} #eta'),
    VCfg(name='phi_2', binning={'nbinsx':40, 'xmin':-3.141593, 'xmax':3.141593}, unit=None, xtitle='muon_{2} #phi'),
    # VCfg(name='l1_reliso05_03', drawname='log(abs(l1_reliso05_03)+0.004)', binning={'nbinsx':40, 'xmin':-6., 'xmax':0.}, unit='', xtitle='log(muon relative isolation cone 0.3)'),
    # VCfg(name='l1_reliso05', drawname='log(abs(l1_reliso05)+0.004)', binning={'nbinsx':40, 'xmin':-6., 'xmax':0.}, unit='', xtitle='log(muon relative isolation cone 0.4)'),
    # VCfg(name='l1_gen_pdgId', binning={'nbinsx':40, 'xmin':-17.5, 'xmax':22.5}, unit=None, xtitle='muon gen match PDG ID'),
    VCfg(name='d0_2_log', drawname='log(abs(d0_2))', binning={'nbinsx':40, 'xmin':-18., 'xmax':-2.}, unit='log(cm)', xtitle='log(muon_{2} d_{0})'),
    VCfg(name='dxy_2_log', drawname='log(abs(dxy_2))', binning={'nbinsx':40, 'xmin':-18., 'xmax':-2.}, unit='log(cm)', xtitle='log(muon_{2} d_{xy})'),
    # VCfg(name='l1_dxy_sig', drawname='log(abs(l1_dxy/l1_dxy_error))', binning={'nbinsx':100, 'xmin':-20., 'xmax':20.}, unit=None, xtitle='muon log(d_{xy}/#sigma(d_{xy}))'),
    VCfg(name='dz_2_log', drawname='log(abs(dz_2))', binning={'nbinsx':40, 'xmin':-18., 'xmax':-2.}, unit='log(cm)', xtitle='log(muon_{2} d_{z})'),
    # VCfg(name='l1_dz_sig', drawname='log(abs(l1_dz/l1_dz_error))', binning={'nbinsx':100, 'xmin':-20., 'xmax':20.}, unit=None, xtitle='muon log(d_{z}/#sigma(d_{z}))'),
    # VCfg(name='delta_phi_l1_met', drawname='abs(TVector2::Phi_mpi_pi(l1_phi-met_phi))', binning={'nbinsx':40, 'xmin':-3.141593, 'xmax':3.141593}, unit=None, xtitle='#Delta #phi (muon, MET)'),
]

tau_mu_special_vars = [
    VCfg(name='delta_eta_1_2', drawname='abs(eta_1 - eta_2)', binning={'nbinsx':40, 'xmin':0, 'xmax':4.5}, unit=None, xtitle='#Delta#eta(#tau, #mu)'),
    # VCfg(name='delta_r_l1_l2', binning={'nbinsx':40, 'xmin':0, 'xmax':4.5}, unit=None, xtitle='#Delta R(#tau, #mu)'),
    VCfg(name='delta_phi_1_2', drawname='abs(TVector2::Phi_mpi_pi(phi_1 - phi_2))', binning={'nbinsx':40, 'xmin':0, 'xmax':3.1415927}, unit=None, xtitle='#Delta #phi(#tau, #mu)'),
...
mu_mu_special_vars = [
    VCfg(name='delta_eta_1_2', drawname='abs(eta_1 - eta_2)', binning={'nbinsx':40, 'xmin':0, 'xmax':4.5}, unit=None, xtitle='#Delta#eta(#mu, #mu)'),
    # VCfg(name='delta_r_l1_l2', binning={'nbinsx':40, 'xmin':0, 'xmax':4.5}, unit=None, xtitle='#Delta R(#mu, #mu)'),
    VCfg(name='delta_phi_1_2', drawname='abs(TVector2::Phi_mpi_pi(phi_1 - phi_2))', binning={'nbinsx':40, 'xmin':0, 'xmax':3.1415927}, unit=None, xtitle='#Delta #phi(#mu, #mu)'),
]

additional_tau_vars = [
    VCfg(name='pt_3', binning={'nbinsx':40, 'xmin':0., 'xmax':100.}, unit='GeV', xtitle='tau p_{T}'),
    VCfg(name='eta_3', binning={'nbinsx':20, 'xmin':-2.5, 'xmax':2.5}, unit=None, xtitle='tau #eta'),
    VCfg(name='decayMode_3', binning={'nbinsx':12, 'xmin':-0.5, 'xmax':11.5}, unit=None, xtitle='tau decay mode'),
    VCfg(name='m_3', binning={'nbinsx':40, 'xmin':0., 'xmax':3.}, unit='GeV', xtitle='tau mass'),
    # VCfg(name='tau1_gen_pdgId', binning={'nbinsx':40, 'xmin':-17.5, 'xmax':22.5}, unit=None, xtitle='tau gen match PDG ID'),
    VCfg(name='dxy_3_log', drawname='log(abs(dxy_3)+0.00001)', binning={'nbinsx':40, 'xmin':-18., 'xmax':0.5}, unit='log(cm)', xtitle='log(tau d_{xy})'),
    ...
    VCfg(name='rawIso_3', binning={'nbinsx':100, 'xmin':0., 'xmax':100.}, unit='GeV', xtitle='tau delta-beta corr. 3-hit isolation'),
    ...
    # VCfg(name='idMVAoldDM_3', binning={'nbinsx':7, 'xmin':-0.5, 'xmax':6.5}, unit='', xtitle='isolation MVA (old DM w/LT)'),
    # VCfg(name='rawMVAoldDM2017v1_3', binning={'nbinsx':7, 'xmin':-0.5, 'xmax':6.5}, unit='', xtitle='2017 v1 isolation MVA (old DM)'),
    # VCfg(name='rawMVAoldDM2017v2_3', binning={'nbinsx':7, 'xmin':-0.5, 'xmax':6.5}, unit='', xtitle='2017 v2 isolation MVA (old DM)'),
    # VCfg(name='rawMVAoldDMdR032017v2_3', binning={'nbinsx':7, 'xmin':-0.5, 'xmax':6.5}, unit='', xtitle='2017 v2 isolation MVA (old DM w/LT cone 0.3)'),
    VCfg(name='puCorr_3', binning={'nbinsx':50, 'xmin':0., 'xmax':50.}, unit='GeV', xtitle='Pileup correction p_{T} sum'),
    # VCfg(name='tau1_footprintCorrection', binning={'nbinsx':50, 'xmin':0., 'xmax':50.}, unit='GeV', xtitle='Footprint correction'),
    VCfg(name='idAntiEle_3', binning={'nbinsx':9, 'xmin':-0.5, 'xmax':8.5}, unit='', xtitle='Anti-electron MVA6'),
    VCfg(name='idAntiMu_3', binning={'nbinsx':4, 'xmin':-0.5, 'xmax':3.5}, unit='', xtitle='Anti-muon discriminator 3'),
