...
generic_vars = [
    ...
    VCfg(name='n_vertices', binning={'nbinsx':81, 'xmin':-0.5, 'xmax':80.5}, unit=None, xtitle='N_{vertices}'),
...
tau_l2_vars = [
    ...
    VCfg(name='l2_byIsolationMVArun2v1DBoldDMwLTraw_zoom', drawname='l2_byIsolationMVArun2v1DBoldDMwLTraw', binning={'nbinsx':20, 'xmin':0.9, 'xmax':1.}, unit='', xtitle='tau isolation MVA (old DM w/LT)'),
